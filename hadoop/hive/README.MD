...
O Apache Hive é um sistema de data warehouse construído sobre o Hadoop que permite consultas e análise de grandes conjuntos de dados armazenados no HDFS. O Hive fornece uma interface semelhante ao SQL chamada HiveQL, que permite aos usuários consultar dados em Hadoop sem precisar escrever código MapReduce.
...
- **E)** Conhecer e explorar o metastore do Hive  
...
3. Abra o editor de queries Hive:  
...
5. Crie o banco de dados `credit_card`:  
  - Execute a query Hive abaixo:  
    ...
    ```
    > **Importante:** Por padrão, o Hive armazena os dados no HDFS na pasta `/user/hive/warehouse`, mas neste exercício iremos armazenar os dados em uma pasta diferente, `/db/credit_card`.
...
11. Insira no conteúdo do arquivo uma linha no formato esperado:  
   ...
   - Clique em `Edit File`.  
   - Insira o conteúdo a seguir: `2017-09-12 01:23:45|a1b2c3d4|Casas Bahia|APROVADA|BRL|19990`
